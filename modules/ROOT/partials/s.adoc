...
For the latter, it is okay to add interest through a more varied use of UK English, just as Games Workshop do.
...
== [[steps, steps (ordered lists)]]steps (ordered lists)
