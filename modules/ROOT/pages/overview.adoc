...
* How to contribute to the project as part of the core team.
...
// * How to translate the project into another language.
...
* *Collaboration*.
{project-name} is developed and published by a link:{uri-core-team}[core team] of passionate volunteers. 
However, the core team also welcomes input and feedback from the wider community -- and features to facilitate this were a big factor in the choice of technologies that we use.
* *Transparency*.
